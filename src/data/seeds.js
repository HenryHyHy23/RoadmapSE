const SEED_QUESTIONS = [
    // === JPD (TIẾNG NHẬT) - 79 Câu ===
            ...
            // === LAB - 30 Câu ===
            ['LAB', 'Actor trong Use Case là?', 'Một hình tròn', 'Người dùng hoặc hệ thống khác', 'Đường nối', 'Mũi tên', 'B', 'Tác nhân tương tác với hệ thống.'],
    ['LAB', 'Mối quan hệ <<include>>?', 'Bắt buộc thực hiện', 'Không bắt buộc', 'Mở rộng', 'Kế thừa', 'A', 'Mối quan hệ bắt buộc giữa các Use Case.'],
    ['LAB', 'Story Map gồm mấy tầng chính?', '2 tầng', '3 tầng', '4 tầng', '5 tầng', 'C', 'Role, Activities, Steps, Details.'],
    ['LAB', 'User Story viết cho ai?', 'Cho máy tính', 'Cho người dùng', 'Cho sếp', 'Cho BA', 'B', 'Mô tả mong muốn của người dùng.'],
    ['LAB', 'Mục tiêu của Test Case?', 'Tăng lương', 'Tìm lỗi và xác minh tính đúng đắn', 'Viết cho đủ', 'Trình diễn', 'B', 'Đảm bảo app chạy đúng mong đợi.'],
    ['LAB', 'Expected Result là gì?', 'Kết quả khi chạy app', 'Kết quả mong đợi theo yêu cầu', 'Mô tả bug', 'Tên của Dev', 'B', 'Kết quả chuẩn cần đạt được.'],
    ['LAB', 'Use Case Diagram mô tả?', 'Cách code', 'Tương tác Actor và Hệ thống', 'Sơ đồ Database', 'Sơ đồ mạng', 'B', 'Mô tả các chức năng và tác nhân.'],
    ['LAB', 'Release trong Story Map thể hiện?', 'Tiền lương', 'Sự phát triển sản phẩm theo giai đoạn', 'Danh sách bug', 'Lịch họp', 'B', 'Các version bàn giao sản phẩm.'],
    ['LAB', 'Mối quan hệ <<extend>>?', 'Luôn luôn xảy ra', 'Chỉ xảy ra trong hoàn cảnh cụ thể', 'Kế thừa', 'Xóa bỏ', 'B', 'Mối quan hệ mở rộng (optional).'],
    ['LAB', 'Ký hiệu Boundary of System?', 'Hình người', 'Hình bầu dục', 'Hình chữ nhật bao quanh Use Case', 'Mũi tên', 'C', 'Phạm vi của hệ thống/module.'],
    ['LAB', 'Định dạng chuẩn tên Use Case?', 'Danh từ', 'Tính từ', 'Động từ + Danh từ', 'Trạng từ', 'C', 'Ví dụ: Đăng nhập hệ thống.'],
    ['LAB', 'Assumption (Giả định) trong LAB?', 'Sự thật hiển nhiên', 'Điều tin là đúng nhưng cần xác minh', 'Lỗi code', 'Yêu cầu khách hàng', 'B', 'Các giả định về rủi ro dự án.'],
    ['LAB', 'High Impact - High Probability là?', 'Rủi ro thấp', 'Rủi ro cực cao cần ưu tiên', 'Task dễ', 'Task không quan trọng', 'B', 'Ảnh hưởng lớn và xác suất sai cao.'],
    ['LAB', 'Narrative Flow trong Story Map?', 'Sơ đồ màu', 'Luồng câu chuyện người dùng', 'Code logic', 'Database', 'B', 'Các bước thực hiện chức năng.'],
    ['LAB', 'Objective của Test Case?', 'Các bước thực hiện', 'Mục đích kiểm tra tính năng gì', 'Lỗi hiện tại', 'Người làm test', 'B', 'Mục tiêu cụ thể của ca kiểm thử.'],
    ['LAB', 'Story Map tầng cao nhất thường là?', 'Steps', 'Details', 'User Goals/Activities', 'Release', 'C', 'Các chức năng bao quát.'],
    ['LAB', 'Giai đoạn "Bảo trì" (Maintenance)?', 'Trước khi code', 'Khi đang code', 'Sau khi release sản phẩm', 'Lúc họp nhóm', 'C', 'Duy trì và sửa lỗi sau triển khai.'],
    ['LAB', 'V-Model là mô hình?', 'Thẳng đứng', 'Mối quan hệ giữa Dev và Test', 'Hình tròn', 'Ngẫu nhiên', 'B', 'Mô hình chữ V liên kết phát triển và kiểm thử.'],
    ['LAB', 'Unit Test thường được viết bởi?', 'Khách hàng', 'BA', 'Developer', 'Designer', 'C', 'Lập trình viên viết unit test cho code mình.'],
    ['LAB', 'System Integration Test (SIT) làm gì?', 'Test 1 hàm', 'Test các module ghép lại', 'Test font chữ', 'Test logo', 'B', 'Kiểm thử tích hợp hệ thống.'],
    ['LAB', 'Tài liệu SRS thường dùng cho?', 'Giai đoạn code', 'Giai đoạn thu thập yêu cầu', 'Giai đoạn deploy', 'Giai đoạn họp báo', 'B', 'Đặc tả yêu cầu phần mềm.'],
    ['LAB', 'Prototype là gì?', 'Bản code hoàn chỉnh', 'Bản mẫu giao diện để demo', 'Tài liệu hướng dẫn', 'Cơ sở dữ liệu', 'B', 'Mô hình/bản mẫu ban đầu.'],
    ['LAB', 'Peer Review là hoạt động?', 'Code 1 mình', 'Đồng nghiệp kiểm tra chéo code/tài liệu', 'Họp với khách hàng', 'Uống cafe', 'B', 'Tăng chất lượng qua đánh giá nội bộ.'],
    ['LAB', 'Regression Testing dùng khi?', 'Mới bắt đầu code', 'Khi code có thay đổi hoặc sửa bug', 'Lúc xóa dự án', 'Khi hết tiền', 'B', 'Kiểm thử hồi quy để tránh lỗi mới.'],
    ['LAB', 'Tại sao cần phân loại Functional/Non-functional?', 'Để cho đẹp', 'Để hiểu rõ yêu cầu nghiệp vụ và kỹ thuật', 'Để tăng dòng code', 'Để sếp vui', 'B', 'Phân định rõ tính năng và chất lượng.'],
    ['LAB', 'Epic trong Story Map?', 'Một bug nhỏ', 'Một nhóm tính năng lớn', 'Một người dùng', 'Một trang web', 'B', 'Khối công việc/tính năng lớn.'],
    ...
    ['SWEc', 'White-box testing tập trung?', 'Giao diện', 'Hành vi', 'Cấu trúc giải thuật bên trong', 'Phản hồi khách hàng', 'C', 'Kiểm thử cấu trúc mã nguồn bên trong.'],
    ['SWEc', 'Non-functional requirement ví dụ?', 'Đăng nhập', 'Thêm giỏ hàng', 'Thời gian phản hồi < 2s', 'Xóa tài khoản', 'C', 'Yêu cầu về hiệu năng/bảo mật.'],
    ['SWEc', 'Mô hình Agile phù hợp khi?', 'Yêu cầu rõ ràng', 'Yêu cầu hay thay đổi', 'Dự án cực ngắn', 'Ít người tham gia', 'B', 'Agile linh hoạt với thay đổi.'],
    ['SWEc', 'Sự tham gia người dùng (User Involvement) cao nhất ở?', 'Waterfall', 'Agile/Scrum', 'V-Model', 'Mô hình lặp', 'B', 'Khách hàng tham gia sâu vào các Sprint.'],
    ['SWEc', 'Integration testing mục đích?', 'Test từng hàm', 'Test kết nối các thành phần', 'Test giao diện', 'Test bảo mật', 'B', 'Đảm bảo các module kết nối trơn tru.'],
    ['SWEc', 'Acceptance Testing là gì?', 'Test của Dev', 'Test cuối trước khi release', 'Test tìm bug nhỏ', 'Test hiệu năng', 'B', 'Kiểm thử chấp nhận bởi khách hàng.'],
    ['SWEc', 'Functional Requirement mô tả?', 'App đẹp thế nào', 'App làm được gì', 'App nhanh ra sao', 'App bảo mật không', 'B', 'Mô tả các tính năng/hành vi của app.'],
    ['SWEc', 'Usability Testing đánh giá?', 'Thuật toán', 'Giao diện và trải nghiệm', 'Tốc độ load', 'Độ bền server', 'B', 'Đánh giá mức độ dễ sử dụng.'],
    ['SWEc', 'Security Testing làm gì?', 'Test màu sắc', 'Tìm lỗ hổng bảo mật', 'Test độ phân giải', 'Test RAM', 'B', 'Bảo vệ dữ liệu khỏi truy cập trái phép.'],
    ['SWEc', 'Tài liệu nào mô tả chi tiết ca kiểm thử?', 'SRS', 'Test Case', 'User Story', 'Source Code', 'B', 'Test case bao gồm các bước và kết quả mong đợi.']
        ];
